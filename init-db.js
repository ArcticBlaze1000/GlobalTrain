...
const tables = [
    ...
    { name: 'flags', schema: `CREATE TABLE flags (id INTEGER PRIMARY KEY AUTOINCREMENT, title TEXT NOT NULL, datapack_id INTEGER, document_id INTEGER, trainee_id INTEGER, user_id INTEGER NOT NULL, user_sent_to_id INTEGER NOT NULL, message TEXT NOT NULL, page TEXT NOT NULL, status TEXT NOT NULL DEFAULT 'open', created_at TEXT NOT NULL DEFAULT (datetime('now')), picked_up_at TEXT, resolved_at TEXT, resolved_by INTEGER, resolution_notes TEXT, signature TEXT, FOREIGN KEY (datapack_id) REFERENCES datapack(id), FOREIGN KEY (document_id) REFERENCES documents(id), FOREIGN KEY (trainee_id) REFERENCES trainees(id), FOREIGN KEY (user_id) REFERENCES users(id), FOREIGN KEY (user_sent_to_id) REFERENCES users(id), FOREIGN KEY (resolved_by) REFERENCES users(id))` },
];
// --- Seed Data ---
const usersToSeed = [
