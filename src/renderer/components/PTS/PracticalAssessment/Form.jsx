...
import { generatePracticalAssessmentPdf } from './PDFGenerator';
...
const Form = ({ user, eventDetails, documentDetails, onProgressUpdate, selectedTraineeId }) => {
    ...
    const checkFileCount = async () => {
        ...
        try {
            ...
            const documentName = 'PracticalAssessment';
    ...
    return (
        <div className="p-6 bg-white rounded-lg shadow-md space-y-6">
            <h2 className="text-2xl font-bold text-center">Practical Assessment</h2>
            ...
            <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
                ...
                <ol className="text-sm text-blue-800 space-y-1">
                    <li>1. Conduct the practical assessment with the selected trainee.</li>
                    <li>2. Scan or save the completed assessment document.</li>
                    <li>3. Save the file to the "PracticalAssessment" folder within the trainee's "06 Candidate" directory.</li>
                    <li>4. Use naming convention: FirstName_LastName_PracticalAssessment.pdf</li>
            ...
            <div className="pt-4 text-center">
                <button
                    onClick={() => generatePracticalAssessmentPdf(eventDetails.id, selectedTraineeId)}
