...
import { generatePhoneticQuizPdf } from './PDFGenerator';
...
const Form = ({ user, eventDetails, documentDetails, onProgressUpdate }) => {
    ...
    return (
        <div className="p-6 bg-white rounded-lg shadow-md space-y-6">
            <h2 className="text-2xl font-bold text-center">Phonetic Quiz</h2>
            ...
            <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
                ...
                <ol className="text-sm text-blue-800 space-y-1">
                    <li>1. Conduct phonetic quiz assessments with each trainee</li>
                    <li>2. Scan or save completed quiz documents</li>
                    <li>3. Save files to the "PhoneticQuiz" folder in "Non Mandatory Files"</li>
                    <li>4. Use naming convention: FirstName_LastName_PhoneticQuiz.pdf</li>
                    <li>5. Status shows ✅ when exactly {fileStatus.expected} files are present</li>
                </ol>
            </div>
            ...
            <div className="pt-4 text-center">
                <button
                    onClick={() => generatePhoneticQuizPdf(eventDetails.id)}
