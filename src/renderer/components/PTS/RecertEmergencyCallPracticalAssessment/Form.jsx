...
import { generateRecertEmergencyCallPracticalAssessmentPdf } from './PDFGenerator';
...
const Form = ({ user, eventDetails, documentDetails, onProgressUpdate, selectedTraineeId }) => {
    ...
    const checkFileCount = async () => {
        ...
        try {
            ...
            const expectedCount = 1; // Always 1 for this per-candidate assessment
            const documentName = 'RecertEmergencyCallPracticalAssessment';
    ...
    return (
        <div className="p-6 bg-white rounded-lg shadow-md space-y-6">
            <h2 className="text-2xl font-bold text-center">Recertification Emergency Call Assessment</h2>
            ...
            <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
                ...
                <ol className="text-sm text-blue-800 space-y-1">
                    <li>1. Conduct the recertification assessment with the selected trainee.</li>
                    <li>2. Scan or save the completed assessment document.</li>
                    <li>3. Save the file to the "RecertEmergencyCallPracticalAssessment" folder within the trainee's "06 Candidate" directory.</li>
                    <li>4. Use naming convention: FirstName_LastName_RecertEmergencyCallPracticalAssessment.pdf</li>
            ...
            <div className="pt-4 text-center">
                <button
                    onClick={() => generateRecertEmergencyCallPracticalAssessmentPdf(eventDetails.id, selectedTraineeId)}
